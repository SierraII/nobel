...
class Scraper:
    ...
    def get_links(self):
        ...
        if not len(self.unparsed_links) == 0:
            ...
            for link in self.unparsed_links:
                ...
                split = link.split("/")
                # dont do a call if its an article slug
                # slugs start with a date
                if split[-1][0:4].isdigit() is False:
                    ...
                    # link is section
                        ...
                        print 'seciton or publication section'
    ...
    def generate_map(self):
        ...
        for link in self.parsed_links:
            ...
            # link is article
            if split[-1][0:4].isdigit() is True:
                priority = 0.7
            # link is subsection
            elif len(split) == 5:
                priority = 0.8
            ...
            xml += "<url><loc>" + link + "</loc><changefreq>daily</changefreq><priority>" + str(priority) + "</priority></url>"
